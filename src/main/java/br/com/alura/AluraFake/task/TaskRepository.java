...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("SELECT COUNT(t) FROM Task t WHERE t.course = :course AND t.taskType = :#{#taskType.name()}")
    long countByCourseAndTaskType(@Param("course") Course course, @Param("taskType") Type taskType);
